...
switch CI_MODE
    ...
    case 1
        ...
        deputy_rel0_LVLH(1, 1:6) = [X0(1,1)*cos(alpha01); -X0(1,2)*sin(alpha01); X0(1,3)*sin(alpha01); -X0(1,4)*sin(alpha01); -X0(1,5)*cos(alpha01); X0(1,6)*cos(alpha01)];    % second deputy                                                                                                        % first deputy
        deputy_rel0_LVLH(2, 1:6) = [X0(2,1)*cos(alpha02); -X0(2,2)*sin(alpha02); X0(2,3)*sin(alpha02); -X0(2,4)*sin(alpha02); -X0(2,5)*cos(alpha02); X0(2,6)*cos(alpha02)];    % second deputy
        deputy_rel0_LVLH(3, 1:6) = [X0(3,1)*cos(alpha03); -X0(3,2)*sin(alpha03); X0(3,3)*sin(alpha03); -X0(3,4)*sin(alpha03); -X0(3,5)*cos(alpha03); X0(3,6)*cos(alpha03)];    % third deputy
