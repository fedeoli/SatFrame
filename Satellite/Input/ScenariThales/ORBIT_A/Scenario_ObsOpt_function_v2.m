function [params, satellites_iner_ECI, satellites_attitude] = Scenario_ObsOpt_function_v2(params,DynOpt,struct)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%0
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %                     ANALYSIS SETTINGS
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    DeputiesAttitude_V2_2_function(params,satellites_attitude,N_deputy)
