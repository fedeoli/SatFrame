...
params.ALQR = 1;                            % params.ALQR = 1 : the control is evaluated by means of the Augmented LQR strategy (Riccati differential equation is solved)
...
params.ALQR_J2 = 1;                         % params.ALQR_J2 = 1 : the Riccati differential equation is solved with the model taking into account J2 linearized effects
...
% Scenario E Specifications (Start: Along 5 km)
...
OrbitalControlParams_V2_2_marco;
% T_horizon = tfinal;
% params.DT_burn = T_horizon/(T_horizon/T*40);                                  % The impulsive DT will be applied every DT_burn. Suggestion: select odd fractions of the period
...
% Scenario E Specifications (Finish: Helix Baseline cross-track 500m)
x0 = 0.25;
y0 = 2*x0;
z0 = 4*x0;
