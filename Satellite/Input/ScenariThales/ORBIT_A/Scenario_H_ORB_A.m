...
% Scenario H Specifications (Start: Helix with 500m cross-track)
x0 = 0.25;
y0 = 2*x0;
z0 = 4*x0;
...
T_horizon = 10*T;
params.DT_burn = T/4;                                  % The impulsive DT will be applied every DT_burn. Suggestion: select odd fractions of the period
