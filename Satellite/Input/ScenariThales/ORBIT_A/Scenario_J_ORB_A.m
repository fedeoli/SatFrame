...
% Scenario J Specifications (From helix with cross-track semi-major axis = 40m to helix with cross-track semi-major axis = 250m)
x0 = 0.04;
y0 = 2*x0;
z0 = 4*x0;
xf = 0.25;
...
T_horizon = 5*T;
params.DT_burn = T_horizon/25;                                  % The impulsive DT will be applied every DT_burn. Suggestion: select odd fractions of the period
