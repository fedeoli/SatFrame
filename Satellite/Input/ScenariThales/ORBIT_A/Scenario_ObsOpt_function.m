function params = Scenario_ObsOpt_function(params,DynOpt)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%0
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %                     ANALYSIS SETTINGS
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [satellites_iner_ECI, params, T, a] = Generate_orbit(DynOpt.orbit,params);
    ...
    % ChiefAttitude_V2_2;
    [params, satellites_attitude] = ChiefAttitude_ObsOpt_v2_function(params,DynOpt);
    ...
    % deputy_rel0_LVLH(1, 1:6) = [x0; 0; 0; 0; -y0*n; z0*n];                                                                                                              
    % deputy_rel0_LVLH(2, 1:6) = [x0*cos(120*pi/180); -y0*sin(120*pi/180); z0*sin(120*pi/180); -x0*n*sin(120*pi/180); -y0*n*cos(120*pi/180); z0*n*cos(120*pi/180)];    
    % deputy_rel0_LVLH(3, 1:6) = [x0*cos(240*pi/180); -y0*sin(240*pi/180); z0*sin(240*pi/180); -x0*n*sin(240*pi/180); -y0*n*cos(240*pi/180); z0*n*cos(240*pi/180)];    
    % deputy_rel0_LVLH(4, 1:6) = [0; 1; 0; 0; 0; 0];  
    % deputy_rel0_LVLH(5, 1:6) = [-0.5; -1.5; 0; 0; 0; 0];               
    % deputy_rel0_LVLH(6, 1:6) = [-1.5; 1; 0; 0; 0; 0];                  
    % deputy_rel0_LVLH(7, 1:6) = [1.3; 0.9; 0; 0; 0; 0]; 
    % deputy_rel0_LVLH(8, 1:6) = [0; 0.9; -1.3; 0; 0; 0]; 
    % deputy_rel0_LVLH(9, 1:6) = [1.5; 0; -1.3; 0; 0; 0]; 
    % deputy_rel0_LVLH(10, 1:6) = [-1.5; 0; -1.3; 0; 0; 0]; 
    % deputy_rel0_LVLH(11, 1:6) = [1.5; 0.9; -1.3; 0; 0; 0]; 
    % deputy_rel0_LVLH(12, 1:6) = [1.5; -0.9; -1.3; 0; 0; 0];
    % deputy_rel0_LVLH(13, 1:6) = [0.56; 2.4; -1.94; 0; 0; 0];
    % deputy_rel0_LVLH(14, 1:6) = [-2.1; 0.45; 1.5; 0; 0; 0];
    ...
    params = DeputiesGeometry_V2_3_function(params);
    ...
    DeputiesAttitude_V2_2_function(params,satellites_attitude)
    ...
    params = CollisionAvoidanceParams_V2_2_function(params);
