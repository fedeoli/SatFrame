...
%     eul_Hill2Body = (eul2rotm([pi/2,0,0])*(DynOpt.mag_field_vector/norm(DynOpt.mag_field_vector))')'*180/pi;

    wrap_mag = (DynOpt.mag_field_vector/norm(DynOpt.mag_field_vector));
    eul_Hill2Body = [1*wrap_mag(1),1*wrap_mag(2),1*wrap_mag(3)]*180/pi;
    %%%%%%%%%%%%%%%%%%%%%%%
    q_Hill2Body = RotationConversion_V2_1('EA321toQ', eul_Hill2Body);
    omega_Body2Hill_Body = [5, 0, 0]*pi/180;
