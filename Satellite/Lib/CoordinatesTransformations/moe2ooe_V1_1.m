function ooe = moe2ooe_V1_1(moe, params)
...
%
%   INPUT
%   moe: Array containing satellite's Mean Orbital Elements (MOE)
...
%
%   OUTPUT
%   ooe: Array (1 x 6) containing satellite's Osculating Orbital Elements (OOE).
%
%   VERSION
%   20190301 V1_1:
%   -  First Release
...
ooe = [a_trasf, e_trasf, i_trasf, om_trasf, OM_trasf, an_trasf];
