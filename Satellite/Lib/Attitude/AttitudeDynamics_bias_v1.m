function dw = AttitudeDynamics_bias_v1(w, params)
...
bias = w(8);
if (DynOpt.bias_model == 0) || (DynOpt.synthetic_int == 1)
    omega_Body2ECI_Body = Att_sat(5:7);
else
    omega_Body2ECI_Body = (DynOpt.Y_full_story(:,DynOpt.current_pos)-bias);
end
I = params.sat(1).I;
