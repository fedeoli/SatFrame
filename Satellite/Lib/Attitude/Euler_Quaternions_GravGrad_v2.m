function dw = Euler_Quaternions_GravGrad_v2(~, w, vect_r, vect_v, params, I)
...
mie = params.mi;
R_ECI2Hill = eye(3); % RECI2Hill(vect_r, vect_v);
C_Hill2Body = quat2dcm(q');

R_ECI2Body = C_Hill2Body*R_ECI2Hill;

omega_Hill2ECI_ECI = 0*OmegaHill2ECI(vect_r, vect_v, params.mi);
...
dw(5:7) = I\( - cross_omIom + (3*mie/(r^3))*cross_oIo*0 );
% dw(8:10) = vect_v;
