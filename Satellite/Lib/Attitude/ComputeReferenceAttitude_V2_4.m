function params = ComputeReferenceAttitude_V2_4(t, params)

%   ComputeReferenceAttitude_V2_4.m
...
for i = 1:Ndeputy + 1
    ...
    elseif t > params.ParkingTime && i > 1 && ( strcmpi(params.ControlStrategy, 'Continuous') && isfield(params.sat(i), 'FiringAttitude') && isempty(params.sat(i).FiringAttitude) == 0 )
