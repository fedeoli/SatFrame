function tau = AttitudeControl_V2_3(satellites_attitude, satellites_iner_ECI, t, params)

%   AttitudeControl_V2_3.m
...
for i = 1:Ndeputy + 1
    ...
    if (t > params.ParkingTime && i > 1 && ( ( strcmpi(params.ControlStrategy, 'Continuous') && ( params.u_module(i) > 0 || isempty(params.sat(i).FiringAttitude) == 0 ) ) || ( strcmpi(params.ControlStrategy, 'Impulsive') && params.sat(i).CanManeuverAttitude == 1 ) ) ) || (i == 1 && params.sat(1).CanManeuverAttitude == 1) || ( t <= params.ParkingTime && params.CollisionFlag == 1 && params.sat(i).CA_Maneuvering == 1 )
        ...
        q_ref = RotationConversion_V2_1('DCMtoQ', R_ECI2Body);
