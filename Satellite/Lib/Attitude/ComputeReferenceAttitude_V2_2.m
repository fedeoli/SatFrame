function params = ComputeReferenceAttitude_V2_2(t, params)

%   ComputeReferenceAttitude_V2_2.m
...
for i = 1:Ndeputy + 1
    ...
    if t > params.ParkingTime && i > 1 && ( (strcmpi(params.ControlStrategy, 'Continuous') && params.u_module(i) > 0) || (strcmpi(params.ControlStrategy, 'Impulsive') && params.sat(i).Burn_executed == 0 && params.sat(i).IsBurning == 0 && params.u_module(i) > 0) )
