function [error, position_norm, velocity_norm] = ErrorCalculation_V1_1(deputy_rel_LVLH, t, params)

%   ErrorCalculation_V1_1.m
...
if params.Control   %if the control is applied, compute the errors according to reference trajectory
    ...
    x_ref = params.ReferenceTrajectory(t, params);      %Compute reference state at time "t"
