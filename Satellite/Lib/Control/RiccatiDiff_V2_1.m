function [K, G] = RiccatiDiff_V2_1(params)
...
%
%   20190405 V1_2:
%   - Modification in reference trajectory computation procedure: New Riccati functions (V1_2)
%
%   20200908 V2_2:
%   - Fixed bug on final integration time
...
tfinalRIC = tfinal;                                 % Riccati equation integration final time
...
if params.ALQR_J2   % Enters here if the J2 Augmented model has been selected
    ...
    [~, KGtau] = ode45(@RiccatiKG_J2_V1_2, tau_int, KG0, options, params);
    
else    % Enters here if the Augmented model without J2 has been selected
    
    [~, KGtau] = ode45(@RiccatiKG_HCW_V1_2, tau_int, KG0, options, params);
