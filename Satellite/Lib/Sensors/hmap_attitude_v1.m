...
function DynOpt = hmap_attitude_v1(satellites_iner_ECI,satellites_attitude, DynOpt)
    ...
    for n=1:nagent
        ...
        Mag_1 = R_ECI2Body * mag_field_norm;
        ...
        Mag_2 = R_ECI2Body_v2 * R_ECI2Body * mag_field_norm;
