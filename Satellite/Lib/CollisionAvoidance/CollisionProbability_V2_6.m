function [prob, prob_CA_chief, params] = CollisionProbability_V2_6(x_est, P, params, u)
...
%
%   20200929 V2_6:
%   - Fixed a bug in the triple integral calculation (inverted 'x' and 'z' calculations)
