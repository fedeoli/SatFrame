...
if strcmpi(params.PlotWindowFormat, 'single')
    ...
    for i = 1:N_deputy+1
        ...
        plot(time_plot, eul_Hill2Body(3*i,:)*180/pi)
        plot(time_plot, unwrap(DesiredAttitude_out(3*i,:))*180/pi, ':')
        xlabel(time_label)
        ...
        set(ttl, 'FontSize', 16, 'fontweight', 'bold');
        plot(time_plot, eul_Hill2Body(3*(i-1)+2,:)*180/pi)
        plot(time_plot, unwrap(DesiredAttitude_out(3*(i-1)+2,:))*180/pi, ':')
        xlabel(time_label)
        ...
        set(ttl, 'FontSize', 16, 'fontweight', 'bold');
        plot(time_plot, unwrap(eul_Hill2Body(3*(i-1)+1,:))*180/pi, 'b')
        plot(time_plot, unwrap(DesiredAttitude_out(3*(i-1)+1,:))*180/pi, 'b:')
        xlabel(time_label)
        ...
        set(ttl, 'FontSize', 16, 'fontweight', 'bold');
        plot(time_plot, omega_Body2Hill_Body(1+3*(i-1), :)*180/pi)
        xlabel(time_label)
        ...
        set(ttl, 'FontSize', 16, 'fontweight', 'bold');
        plot(time_plot, omega_Body2Hill_Body(2+3*(i-1), :)*180/pi)
        xlabel(time_label)
        ...
        set(ttl, 'FontSize', 16, 'fontweight', 'bold');
        plot(time_plot, omega_Body2Hill_Body(3*i, :)*180/pi)
        xlabel(time_label)
...
elseif strcmpi(params.PlotWindowFormat, 'multiple')
    ...
    for i = 1:N_deputy + 1
        ...
        plot(time_plot, omega_Body2Hill_Body(1+3*(i-1), :)*180/pi)
        plot(time_plot, omega_Body2Hill_Body(2+3*(i-1), :)*180/pi)
        plot(time_plot, omega_Body2Hill_Body(3+3*(i-1), :)*180/pi)
        xlabel(time_label)
